...
function addFile(image) {
    var el = $('<li class="post file" data-post-id="' + image.id + '">'
		...
		//+ '<a class="thumb" href="' + image.url + '" target="_blank" title="点击查看原图，拖动排序" style="background-image:url(' + image.thm_url + ')"><span class="file-thumb-title">上传成功</span></a>'
		+ '<a class="thumb" href="' + image.url + '" target="_blank" title="点击查看原图，拖动排序"><img src="' + image.thm_url + '" style="width:90px;"/></a>'//this.thumb
