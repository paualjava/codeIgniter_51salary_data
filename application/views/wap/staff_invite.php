...
function showdata()
{
 $.ajax({
	type: "GET",
	url: "/index.php?m=wap&c=staff_invite&a=indexajax&category=blog&p="+(page+1),
	dataType: "text",
...
?>
  <td ><a class="show0<?php echo $i;?>" title="<?php echo $row->name;?>" href="<?php echo $site_url;?>wap/staff_invite/index/category_<?php echo $row->id;?>"><?php echo $row->name;?></a></td>
  <?php echo ($i % 4==0) ? "</tr>
  <tr>" : "";?>
<?php $i++; }?>
...
?> 
<a title="<?php echo $row->name;?>" href="<?php echo $site_url;?>wap/staff_invite/show/<?php echo $row->id;?>">
