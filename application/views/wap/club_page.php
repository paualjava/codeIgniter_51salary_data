...
function showdata()
{
 $.ajax({
	type: "GET",
	url: "/index.php?m=wap&c=club_page&a=indexajax&category=blog&p="+(page+1),
	dataType: "text",
...
?> 
<a title="<?php echo $row->title;?>" href="<?php echo $site_url;?>wap/club_page/show/<?php echo $row->id;?>">
