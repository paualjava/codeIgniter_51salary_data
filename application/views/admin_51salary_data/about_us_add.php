...
<div class="box">
  <div class="box-title">
    <div class="span10" style="float:left">
      <h3><i class="icon-pencil"></i>添加关于我们
      </h3>
    </div>
  ...
  <div class="box-content">
	...
	<input name="form_is_post" type="hidden" value="1" />
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="title" id="title" value="" class="input-xxlarge ui-wizard-content ui-helper-reset ui-state-default valid" data-rule-required="true" data-rule-maxlength="200" >
          <span class="maroon">*</span><span class="help-inline">请输入标题</span> <span for="title" class="help-block error valid"></span></div>
       </div>
      <div class="control-group">
        <label for="content" class="control-label">内容：</label>
        <div class="controls">
          <textarea class="input-xxlarge" name="content" id="content" ></textarea>
          <span class="help-inline">请输入内容</span> </div>
       </div>
      <div class="control-group">
        <label for="is_show" class="control-label">审核显示：</label>
        <div class="controls">
          <label class="radio inline" style="padding-top:2px"><input type="radio" name="is_show" id="is_show" value="1" checked="checked" style="margin-top:0px"/>是</label>
          <label class="radio inline" style="padding-top:2px"><input type="radio" name="is_show" id="is_show" value="2" style="margin-top:0px"/>否</label>
        </div>
      </div>
      <div class="control-group">
        <label for="sort_order" class="control-label">排序：</label>
        <div class="controls">
          <input type="text" name="sort_order" id="sort_order" value="0" class="input-xxlarge ui-wizard-content ui-helper-reset ui-state-default valid" data-rule-number="true" data-rule-digits="true" >
          <span class="help-inline">请输入整数，数值越大，越靠前</span> <span for="sort_order" class="help-block error valid"></span></div>
       </div>
      <div class="form-actions">
        <?php if(role("about_us_add")){?><button id="bsubmit" type="submit" data-loading-text="提交中..." class="btn btn-primary">保存</button><?php }?>
