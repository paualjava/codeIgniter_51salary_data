  ...
  <div class="box-content">
	...
	<input name="form_is_post" type="hidden" value="1" />
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="title" id="title" value="" class="input-xxlarge ui-wizard-content ui-helper-reset ui-state-default valid" data-rule-required="true" >
          <span class="maroon">*</span><span class="help-inline">请输入标题</span> <span for="title" class="help-block error valid"></span></div>
       </div>
      <div class="control-group">
        <label for="url" class="control-label">url：</label>
        <div class="controls">
          <input type="text" name="url" id="url" value="" class="input-xxlarge ui-wizard-content ui-helper-reset ui-state-default valid" >
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <textarea class="input-xxlarge" name="info" id="info" ></textarea>
          <span class="help-inline">请输入内容</span> </div>
       </div>
      <div class="form-actions">
        <?php if(role("page_info_add")){?><button id="bsubmit" type="submit" data-loading-text="提交中..." class="btn btn-primary">保存</button><?php }?>
