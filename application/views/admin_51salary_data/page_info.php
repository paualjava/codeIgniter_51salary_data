  ...
  <div class="box-content">
    <div class="row-fluid">
      <div class="span12 control-group">
       <div class="span5 pull-left"><?php if(role("page_info_add")){?><a class="btn" href="<?php echo $admin_url;?>page_info_add"><i class="icon-plus"></i>添加页面</a><?php }?>  <a class="btn" href="javascript:location.reload()"><i class="icon-refresh"></i>刷新</a> <?php if(role("page_info_del")){?><a class="btn" href="javascript:delete_all('<?php echo $admin_url;?>page_info/delete_all/')"><i class="icon-trash"></i>批量删除</a><?php }?>  <a class="btn" href="<?php echo $admin_url;?>page_info/export_excel"><i class="icon-share"></i>导出Excel</a> </div>
